    ...
    mounted(){
      let autocomplete =  new google.maps.places.Autocomplete(
        ...
        autocomplete.addListener('place_changed',()=>{
            ...
            console.log(place)
            this.getUserLocationOnTheMap(place.geometry.location.lat(),place.geometry.location.lng())
        })
      ...
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(
          (position) => {
            ...
            this.getUserLocationOnTheMap(position.coords.latitude,position.coords.longitude)
          },
          (error) => {
