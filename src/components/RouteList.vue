<template>
  <section class="route-list-view">
     <div class="route-list-view-header">
         ...
         <select name="" id="" class="field" @change="sortRoute($event)">
     ...
     <div :style="{backgroundColor:route.color}" class="item" v-for="route in routes" :key="route.id" @click="RouteItemPressed(route)">
         <div> <i class="marker alternative icon"></i>{{route.origin.address}}</div>
